...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the ATTOLABS SDK" },
      { type: "command", text: "npm install @ATTOLABS/sdk" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx ATTOLABS init" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { Agent, Tool } ", keyword2: "from", string: " '@ATTOLABS/sdk'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { VectorMemory } ", keyword2: "from", string: " '@ATTOLABS/memory'" },
      { type: "gap" },
  ...
  },
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Deploy to ATTOLABS Cloud" },
      { type: "command", text: "ATTOLABS deploy --prod" },
      { type: "gap" },
      ...
      { type: "url", text: "  → https://agents.ATTOLABS.dev/researcher" },
    ],
  },
]
