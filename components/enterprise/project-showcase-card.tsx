...
const cardClassName =
  "group block relative w-full aspect-video overflow-hidden bg-[#111] lg:rounded-[100px] md:rounded-[64px] rounded-[32px]"
    ...
    <>
      ...
      <div className="absolute inset-0 z-10 flex flex-col p-6 md:p-10 lg:p-14 max-w-7xl mx-auto w-full">
        ...
        <div className="mt-auto pt-8">
          <RevealLines className="text-sm text-white/70 mb-3 max-w-md line-clamp-3">
            {project.subtitle}
          </RevealLines>
          <RevealText
            as="h3"
